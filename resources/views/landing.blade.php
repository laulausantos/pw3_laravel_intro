...
@section('content')
    ...
    <section class="relative overflow-hidden rounded-3xl bg-slate-950 px-8 py-16 text-white shadow-2xl">
        ...
        <div class="relative z-10 max-w-3xl">
            <p
                class="inline-block rounded-full border border-cyan-300/40 bg-cyan-300/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-cyan-200">
                Solução Web Moderna
            </p>
            ...
            <div class="mt-8 flex flex-wrap gap-3">
                <a href="#funcionalidades"
                    class="rounded-xl bg-cyan-400 px-6 py-3 font-semibold text-slate-900 hover:bg-cyan-300">Ver
                    funcionalidades</a>
                <a href="#contato"
                    class="rounded-xl border border-slate-500 px-6 py-3 font-semibold text-slate-100 hover:bg-slate-800">Falar
                    com a equipe</a>
            </div>
        </div>
    </section>
    ...
    <section id="funcionalidades" class="mt-10">
        ...
        <div class="grid gap-5 md:grid-cols-3">
            <article
                class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 transition hover:-translate-y-1 hover:shadow-lg">
            ...
            <article
                ...
                <p class="mt-3 text-slate-600">Reduza tarefas repetitivas com processos integrados e formulários eficientes.
                </p>
            </article>
            ...
            <article
                ...
                <p class="mt-3 text-slate-600">Visualize resultados com blocos claros para tomada de decisão mais segura.
                </p>
            </article>
        </div>
    </section>
    ...
    <section id="diferenciais"
        class="mt-10 grid gap-6 rounded-2xl bg-gradient-to-r from-slate-900 to-slate-800 p-8 text-white md:grid-cols-2">
        <div>
        ...
        <ul class="space-y-3 text-slate-100">
            <li class="rounded-lg border border-white/20 bg-white/5 px-4 py-3">Interface responsiva para desktop e celular
            </li>
            <li class="rounded-lg border border-white/20 bg-white/5 px-4 py-3">Componentes reutilizáveis e fáceis de manter
            </li>
            <li class="rounded-lg border border-white/20 bg-white/5 px-4 py-3">Design moderno com contraste e hierarquia
                visual</li>
        </ul>
    </section>
    ...
    <section id="contato" class="mt-10 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div class="mt-6 flex flex-wrap gap-3">
            <a href="#"
                class="rounded-xl bg-slate-900 px-6 py-3 font-semibold text-white hover:bg-slate-700">Solicitar
                demonstração</a>
            <a href="#"
                class="rounded-xl border border-slate-300 px-6 py-3 font-semibold text-slate-700 hover:bg-slate-100">Ver
                documentação</a>
        </div>
    </section>
